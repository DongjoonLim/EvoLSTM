...
X_train=np.load('prepData/X_train_gap_camFam3_v3_chr2_size10.npy')
X_val=np.load('prepData/X_val_gap_camFam3_v3_chr2_size10.npy')
X_test=np.load('prepData/X_test_gap_camFam3_v3_chr2_size10.npy')
y_train=np.load('prepData/y_train_gap_camFam3_v3_chr2_size10.npy')
y_val=np.load('prepData/y_val_gap_camFam3_v3_chr2_size10.npy')
y_test=np.load('prepData/y_test_gap_camFam3_v3_chr2_size10.npy')

y_train1 = np.load('prepData/y_train1_gap_camFam3_v3_chr2_size10.npy')
y_val1 = np.load('prepData/y_val1_gap_camFam3_v3_chr2_size10.npy')
y_test1 = np.load('prepData/y_test1_gap_camFam3_v3_chr2_size10.npy')
...
def grid_search(latent, half,train_size, X_train, y_train, y_train1):
    ...
    model1.save("models/gap_{}_{}_1.h5".format(train_size,half))
    model2.save("models/gap_{}_{}_2.h5".format(train_size,half))
    model3.save("models/gap_{}_{}_10.h5".format(train_size,half))
    ...
    #model8.save("models/gap_{}_{}_500.h5".format(train_size,half))
    
    encoder_model1.save("models/Egap_{}_{}_1.h5".format(train_size,half))
    encoder_model2.save("models/Egap_{}_{}_2.h5".format(train_size,half))
    encoder_model3.save("models/Egap_{}_{}_10.h5".format(train_size,half))
    ...
    #encoder_model8.save("models/E_gap_{}_{}_500.h5".format(train_size,half))
    
    decoder_model1.save("models/Dgap_{}_{}_1.h5".format(train_size,half))
    decoder_model2.save("models/Dgap_{}_{}_2.h5".format(train_size,half))
    decoder_model3.save("models/Dgap_{}_{}_10.h5".format(train_size,half))
    ...
    #decoder_model8.save("models/D_gap_{}_{}_500.h5".format(train_size,half))
