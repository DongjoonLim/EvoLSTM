...
anc = str(np.load('prepData/insert1Anc_{}_{}.npy'.format(ancName, desName)))[:10400000]
des = str(np.load('prepData/insert1Des_{}_{}.npy'.format(ancName, desName)))[:10400000]
...
encoded_des =onehot_encoder.transform(integer_des).astype(np.uint8)

integer_anc = integer_encoded_anc.reshape(len(integer_encoded_anc), 1)
encoded_anc = onehot_encoder.transform(integer_anc).astype(np.uint8)
...
X_test = X[-500000:]
X_val = X[-700000:-500000]
y_train1 = y1[:train_size]
y_test1 = y1[-500000:]
y_val1 = y1[-700000:-500000]
y_train = y[:train_size]
y_test = y[-500000:]
y_val = y[-700000:-500000]
...
def grid_search(latent, half,train_size, X_train, y_train, y_train1):
    ...
    model1.save("models/insert1_{}_{}_{}_{}_{}_1.h5".format(ancName, desName,train_size,half,seq_length))
    model2.save("models/insert1_{}_{}_{}_{}_{}_2.h5".format(ancName, desName,train_size,half,seq_length))
    model3.save("models/insert1_{}_{}_{}_{}_{}_10.h5".format(ancName, desName,train_size,half,seq_length))
    model4.save("models/insert1_{}_{}_{}_{}_{}_30.h5".format(ancName, desName,train_size,half,seq_length))
    ...
    encoder_model1.save("models/E_insert1_{}_{}_{}_{}_{}_1.h5".format(ancName, desName,train_size,half,seq_length))
    encoder_model2.save("models/E_insert1_{}_{}_{}_{}_{}_2.h5".format(ancName, desName,train_size,half,seq_length))
    encoder_model3.save("models/E_insert1_{}_{}_{}_{}_{}_10.h5".format(ancName, desName,train_size,half,seq_length))
    encoder_model4.save("models/E_insert1_{}_{}_{}_{}_{}_30.h5".format(ancName, desName,train_size,half,seq_length))
    ...
    decoder_model1.save("models/D_insert1_{}_{}_{}_{}_{}_1.h5".format(ancName, desName,train_size,half,seq_length))
    decoder_model2.save("models/D_insert1_{}_{}_{}_{}_{}_2.h5".format(ancName, desName,train_size,half,seq_length))
    decoder_model3.save("models/D_insert1_{}_{}_{}_{}_{}_10.h5".format(ancName, desName,train_size,half,seq_length))
    decoder_model4.save("models/D_insert1_{}_{}_{}_{}_{}_30.h5".format(ancName, desName,train_size,half,seq_length))
...
def grid_predict(train_size, half, epoch, X_test, y_test):
    model1 = load_model("models/insert1_{}_{}_{}_{}_{}_{}.h5".format(ancName, desName,train_size,half,seq_length,epoch))

    encoder_model1 = load_model("models/E_insert1_{}_{}_{}_{}_{}_{}.h5".format(ancName, desName,train_size,half,seq_length, epoch))

    decoder_model1 =load_model("models/D_insert1_{}_{}_{}_{}_{}_{}.h5".format(ancName, desName,train_size,half,seq_length, epoch))
...
np.save('inputAll_{}_{}_{}_{}'.format(ancName, desName, train_size, seq_length), inputAll)
np.save('predAll_{}_{}_{}_{}'.format(ancName, desName, train_size, seq_length), predAll)
np.save('outputAll_{}_{}_{}_{}'.format(ancName, desName, train_size, seq_length), outputAll)
