...
def grid_predict(train_size, half, epoch, X_test, y_test):
    model1 = load_model("models/insert1_{}_{}_{}_{}_{}.h5".format(ancName, desName,train_size,half,epoch))

    encoder_model1 = load_model("models/E_insert1_{}_{}_{}_{}_{}.h5".format(ancName, desName,train_size,half, epoch))

    decoder_model1 =load_model("models/D_insert1_{}_{}_{}_{}_{}.h5".format(ancName, desName,train_size,half, epoch))
...
def plotPointMut(n_groups, predSeq, trueSeq, ancNuc, desNuc):
    ...
    plt.tight_layout()
    plt.savefig('figures/{}_{}_{}->{}.png'.format(ancName, desName, ancNuc, desNuc))
...
def plotScatter(n_groups, predSeq, trueSeq, ancNuc, desNuc):
    ...
    plt.ylabel('True')
    plt.title('{} to {} point mutation'.format(ancNuc, desNuc))
    plt.savefig('figures/scatter_{}_{}_{}->{}.png'.format(ancName, desName, ancNuc, desNuc))
    plt.show()
