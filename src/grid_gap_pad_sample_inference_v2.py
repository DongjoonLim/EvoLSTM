...
def grid_predict(train_size, half, epoch, X_test, y_test):
    model1 = load_model("models/gap_pad_v2_{}_{}_{}.h5".format(train_size,half,epoch))

    encoder_model1 = load_model("models/Egap_pad_v2_{}_{}_{}.h5".format(train_size,half, epoch))

    decoder_model1 =load_model("models/Dgap_pad_v2_{}_{}_{}.h5".format(train_size,half, epoch))
...
def get_data(trainInd, valInd, testInd):
    X_train=np.load('prepData/X_train_gap_pad_camFam3_v3_chr2_size10.npy')[:trainInd]
    X_val=np.load('prepData/X_val_gap_pad_camFam3_v3_chr2_size10.npy')[:valInd]
    X_test=np.load('prepData/X_test_gap_pad_camFam3_v3_chr2_size10.npy')[:testInd]
    y_train=np.load('prepData/y_train_gap_pad_camFam3_v3_chr2_size10.npy')[:trainInd]
    y_val=np.load('prepData/y_val_gap_pad_camFam3_v3_chr2_size10.npy')[:valInd]
    y_test=np.load('prepData/y_test_gap_pad_camFam3_v3_chr2_size10.npy')[:testInd]

    y_train1 = np.load('prepData/y_train1_gap_pad_camFam3_v3_chr2_size10.npy')[:trainInd]
    y_val1 = np.load('prepData/y_val1_gap_pad_camFam3_v3_chr2_size10.npy')[:valInd]
    y_test1 = np.load('prepData/y_test1_gap_pad_camFam3_v3_chr2_size10.npy')[:testInd]
