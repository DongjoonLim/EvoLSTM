...
def grid_search(latent, half,train_size, X_train, y_train, y_train1):
    ...
    model1.save("models/{}_{}_1_double.h5".format(train_size,half))
    model2.save("models/{}_{}_2_double.h5".format(train_size,half))
    model3.save("models/{}_{}_10_double.h5".format(train_size,half))
    ...
    encoder_model1.save("models/E{}_{}_1_double.h5".format(train_size,half))
    encoder_model2.save("models/E{}_{}_2_double.h5".format(train_size,half))
    encoder_model3.save("models/E{}_{}_10_double.h5".format(train_size,half))
    ...
    decoder_model1.save("models/D{}_{}_1_double.h5".format(train_size,half))
    decoder_model2.save("models/D{}_{}_2_double.h5".format(train_size,half))
    decoder_model3.save("models/D{}_{}_10_double.h5".format(train_size,half))
