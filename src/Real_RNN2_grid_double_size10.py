...
X_train=np.load('prepData/X_train_camFam3_v3_chr2_size10.npy')
X_val=np.load('prepData/X_val_camFam3_v3_chr2_size10.npy')
X_test=np.load('prepData/X_test_camFam3_v3_chr2_size10.npy')
y_train=np.load('prepData/y_train_camFam3_v3_chr2_size10.npy')
y_val=np.load('prepData/y_val_camFam3_v3_chr2_size10.npy')
y_test=np.load('prepData/y_test_camFam3_v3_chr2_size10.npy')

y_train1 = np.load('prepData/y_train1_camFam3_v3_chr2_size10.npy')
y_val1 = np.load('prepData/y_val1_camFam3_v3_chr2_size10.npy')
y_test1 = np.load('prepData/y_test1_camFam3_v3_chr2_size10.npy')
...
def grid_search(latent, half,train_size, X_train, y_train, y_train1):
    ...
    model1.save("models/{}_{}_1_double_size{}.h5".format(train_size,half, seq_length))
    model2.save("models/{}_{}_2_double_size{}.h5".format(train_size,half, seq_length))
    model3.save("models/{}_{}_10_double_size{}.h5".format(train_size,half, seq_length))
    #model4.save("models/{}_{}_30_double_size{}.h5".format(train_size,half, seq_length))
    #model5.save("models/{}_{}_50_double_size{}.h5".format(train_size,half, seq_length))
    #model6.save("models/{}_{}_80_double_size{}.h5".format(train_size,half, seq_length))
    #model7.save("models/{}_{}_100_double_size{}.h5".format(train_size,half, seq_length))
    #model8.save("{}_{}_500.h5".format(train_size,half))
    
    encoder_model1.save("models/E{}_{}_1_double_size{}.h5".format(train_size,half, seq_length))
    encoder_model2.save("models/E{}_{}_2_double_size{}.h5".format(train_size,half, seq_length))
    encoder_model3.save("models/E{}_{}_10_double_size{}.h5".format(train_size,half, seq_length))
    #encoder_model4.save("models/E{}_{}_30_double_size{}.h5".format(train_size,half, seq_length))
    #encoder_model5.save("models/E{}_{}_50_double_size{}.h5".format(train_size,half, seq_length))
    #encoder_model6.save("models/E{}_{}_80_double_size{}.h5".format(train_size,half, seq_length))
    #encoder_model7.save("models/E{}_{}_100_double_size{}.h5".format(train_size,half, seq_length))
    #encoder_model8.save("E{}_{}_500.h5".format(train_size,half))
    
    decoder_model1.save("models/D{}_{}_1_double_size{}.h5".format(train_size,half, seq_length))
    decoder_model2.save("models/D{}_{}_2_double_size{}.h5".format(train_size,half, seq_length))
    decoder_model3.save("models/D{}_{}_10_double_size{}.h5".format(train_size,half, seq_length))
    #decoder_model4.save("models/D{}_{}_30_double_size{}.h5".format(train_size,half, seq_length))
    #decoder_model5.save("models/D{}_{}_50_double_size{}.h5".format(train_size,half, seq_length))
    #decoder_model6.save("models/D{}_{}_80_double_size{}.h5".format(train_size,half, seq_length))
    #decoder_model7.save("models/D{}_{}_100_double_size{}.h5".format(train_size,half, seq_length))
