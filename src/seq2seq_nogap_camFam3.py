...
X_train=np.load('prepData/X_train_camFam3.npy')
X_val=np.load('prepData/X_val_camFam3.npy')
X_test=np.load('prepData/X_test_camFam3.npy')
y_train=np.load('prepData/y_train_camFam3.npy')
y_val=np.load('prepData/y_val_camFam3.npy')
y_test=np.load('prepData/y_test_camFam3.npy')
