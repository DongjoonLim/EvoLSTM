...
X_train=np.load('prepData/X_train_camFam3_1mut_v3_chr2.npy')[:12000]
X_val=np.load('prepData/X_val_camFam3_1mut_v3_chr2.npy')[:10000]
X_test=np.load('prepData/X_test_camFam3_1mut_v3_chr2.npy')[:4000]
y_train=np.load('prepData/y_train_camFam3_1mut_v3_chr2.npy')[:12000]
y_val=np.load('prepData/y_val_camFam3_1mut_v3_chr2.npy')[:10000]
y_test=np.load('prepData/y_test_camFam3_1mut_v3_chr2.npy')[:4000]

y_train1 = np.load('prepData/y_train1_camFam3_1mut_v3_chr2.npy')[:12000]
y_val1 = np.load('prepData/y_val1_camFam3_1mut_v3_chr2.npy')[:10000]
y_test1 = np.load('prepData/y_test1_camFam3_1mut_v3_chr2.npy')[:4000]
...
X_train=np.load('prepData/X_train_camFam3_1mut_v3_chr2.npy')[:96000]
y_train=np.load('prepData/y_train_camFam3_1mut_v3_chr2.npy')[:96000]
y_train1 = np.load('prepData/y_train1_camFam3_1mut_v3_chr2.npy')[:96000]
y_train1 = concat(X_train, y_train1)
...
#grid_search(1024, 512, 96000, X_train, y_train, y_train1)
grid_search(2048, 1024, 96000, X_train, y_train, y_train1)

with open('loss_hist_96d.txt', 'wb') as fp:
...
X_test5=np.load('prepData/X_test_camFam3_1mut_v3.npy')
y_test5=np.load('prepData/y_test_camFam3_1mut_v3.npy')
