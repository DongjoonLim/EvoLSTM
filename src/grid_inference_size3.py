...
def grid_predict(train_size, half, epoch, X_test, y_test):
    model1 = load_model("models/{}_{}_{}_size3.h5".format(train_size,half,epoch))

    encoder_model1 = load_model("models/E{}_{}_{}_size3.h5".format(train_size,half, epoch))

    decoder_model1 =load_model("models/D{}_{}_{}_size3.h5".format(train_size,half, epoch))
