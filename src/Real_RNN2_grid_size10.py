...
def grid_search(latent, half,train_size, X_train, y_train, y_train1):
    ...
    model1.save("models/{}_{}_1_size{}.h5".format(train_size,half, seq_length))
    model2.save("models/{}_{}_2_size{}.h5".format(train_size,half, seq_length))
    model3.save("models/{}_{}_10_size{}.h5".format(train_size,half, seq_length))
    #model4.save("models/{}_{}_30_size{}.h5".format(train_size,half))
    #model5.save("models/{}_{}_50_size{}.h5".format(train_size,half))
    #model6.save("models/{}_{}_80_size{}.h5".format(train_size,half))
    #model7.save("models/{}_{}_100_size{}.h5".format(train_size,half))
    #model8.save("{}_{}_500.h5".format(train_size,half))
    
    encoder_model1.save("models/E{}_{}_1_size{}.h5".format(train_size,half, seq_length))
    encoder_model2.save("models/E{}_{}_2_size{}.h5".format(train_size,half, seq_length))
    encoder_model3.save("models/E{}_{}_10_size{}.h5".format(train_size,half, seq_length))
    #encoder_model4.save("models/E{}_{}_30_size{}.h5".format(train_size,half))
    #encoder_model5.save("models/E{}_{}_50_size{}.h5".format(train_size,half))
    #encoder_model6.save("models/E{}_{}_80_size{}.h5".format(train_size,half))
    #encoder_model7.save("models/E{}_{}_100_size{}.h5".format(train_size,half))
    #encoder_model8.save("E{}_{}_500.h5".format(train_size,half))
    
    decoder_model1.save("models/D{}_{}_1_size{}.h5".format(train_size,half, seq_length))
    decoder_model2.save("models/D{}_{}_2_size{}.h5".format(train_size,half, seq_length))
    decoder_model3.save("models/D{}_{}_10_size{}.h5".format(train_size,half, seq_length))
    #decoder_model4.save("models/D{}_{}_30_size{}.h5".format(train_size,half))
    #decoder_model5.save("models/D{}_{}_50_size{}.h5".format(train_size,half))
    #decoder_model6.save("models/D{}_{}_80_size{}.h5".format(train_size,half))
    #decoder_model7.save("models/D{}_{}_100_size{}.h5".format(train_size,half))
