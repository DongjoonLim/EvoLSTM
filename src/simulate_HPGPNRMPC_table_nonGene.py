...
anc = str(np.load('prepData/insert2Anc_{}_{}_nonGene_chr2.npy'.format(ancName, desName)))[:7872000]
des = str(np.load('prepData/insert2Des_{}_{}_nonGene_chr2.npy'.format(ancName, desName)))[:7872000]
...
model = load_model("models/insert2__HPGPNRMPC_hg38__HPGPNRMPC_hg38_none_10.h5")
encoder_model = load_model("models/E_insert2__HPGPNRMPC_hg38__HPGPNRMPC_hg38_none_10.h5")
decoder_model = load_model("models/D_insert2__HPGPNRMPC_hg38__HPGPNRMPC_hg38_none_10.h5")
