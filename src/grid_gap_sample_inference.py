...
def grid_predict(train_size, half, epoch, X_test, y_test):
    model1 = load_model("models/gap_{}_{}_{}.h5".format(train_size,half,epoch))

    encoder_model1 = load_model("models/Egap_{}_{}_{}.h5".format(train_size,half, epoch))

    decoder_model1 =load_model("models/Dgap_{}_{}_{}.h5".format(train_size,half, epoch))
