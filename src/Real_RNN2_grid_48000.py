...
X_train=np.load('prepData/X_train_camFam3_1mut_v3_chr2.npy')[:48000]
y_train=np.load('prepData/y_train_camFam3_1mut_v3_chr2.npy')[:48000]
y_train1 = np.load('prepData/y_train1_camFam3_1mut_v3_chr2.npy')[:48000]
y_train1 = concat(X_train, y_train1)
...
with open('loss_hist_48.txt', 'wb') as fp:
