...
def grid_predict(train_size, half, epoch, X_test, y_test):
    model1 = load_model("models/gap_pad_{}_{}_{}.h5".format(train_size,half,epoch))

    encoder_model1 = load_model("models/Egap_pad_{}_{}_{}.h5".format(train_size,half, epoch))

    decoder_model1 =load_model("models/Dgap_pad_{}_{}_{}.h5".format(train_size,half, epoch))
